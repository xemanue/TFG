...
Por último, para la apariencia general de la aplicación, se ha usado el tema \textit{catppuccin latte}\footnote{https://catppuccin.com/} de la librería \textit{qt-themes}\footnote{https://github.com/beatreichenbach/qt-themes}.
