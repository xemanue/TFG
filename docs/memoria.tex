...
\begin{document}
    ...
    Todo el código fuente desarollado para este Trabajo de Fin de Grado, incluyendo el de esta memoria, se encuentra disponible en el siguiente repositorio de GitHub:

    \begin{center}
        \url{https://github.com/xemanue/TFG}

        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.5\textwidth]{gh_qr.png}
        \end{figure}
    \end{center}
